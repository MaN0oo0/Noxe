      ...
      <div className="row">
        <div className="col-md-4">
          <div className="welcome">
            ...
            <p style={{ color: "rgb(79,68,68)" }}>
              most watched {title} by day
            </p>
        ...
        {data.slice(0, Range).map((movie, index) => {
          return (
            <div
              key={index}
              className={`col-md-2  ${
                movie.profile_path === null ? "d-none" : ""
              }`}
            >
              <div className={`${styles.item}`}>
                ...
                <span
                  className={`${styles.vote_number} ${
                    !movie.vote_average ? "d-none" : ""
                  }`}
                >
